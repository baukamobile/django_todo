...
from task.views import ListViewtaskSet, CreateSomeTasks, delete_view, detail_view, listtask, submitting_view, update_view
...
urlpatterns = [
    ...
    path('create/', CreateSomeTasks, name='createtask'),
